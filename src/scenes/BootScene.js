class BootScene extends Phaser.Scene {
    ...
    create() {
        ...
        // Create bee animations
        this.anims.create({
            key: 'bee-fly',
            frames: this.anims.generateFrameNumbers('bee-fly', { start: 0, end: 7 }),
            frameRate: 10,
            repeat: -1
        });
        ...
        this.anims.create({
            key: 'bee-attack',
            frames: this.anims.generateFrameNumbers('bee-attack', { start: 0, end: 7 }),
            frameRate: 12,
            repeat: -1
        });
